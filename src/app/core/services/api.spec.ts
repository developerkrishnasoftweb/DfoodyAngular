...
// import { Api } from './api';
// import { IApiResponse, IResultSet } from 'src/app/core/models/api';
...
// const mockBlob = 'asjhdgjhsadhjasjd ajsgsjhajds';
// const mockIResultSet: IResultSet[] = [{
//    resultCode: 'R00',
//    status: 'SUCCESS',
...
// function removeByIdMethodTest(api, httpMock, mockData) {
//    api.removeById(mockData.data.id)
//       .subscribe((response: IApiResponse) => {
//          expect(response.data.id).toEqual(mockData.data.id);
//       });
// }

// function removeMethodTest(api, httpMock, mockData, query, routeParams) {
//    if (query) {
//       api.remove(mockData, query, routeParams)
//          .subscribe((response: IApiResponse) => {
//             expect(response).toBeDefined();
//          });
//    } else {
...
//          it('should remove payload to server without query string',
//             inject([HttpTestingController, HttpClient], (httpMock: HttpTestingController, http: HttpClient) => {
//                const api: Api<ITest> = new Api<ITest>(http, urlEndPoint, Test);
//                const mockData = {
//                   data: [mockTestData],
...
//                removeMethodTest(api, httpMock, mockData, null, null);
...
//          it('should delete payload to server with query string',
//             inject([HttpTestingController, HttpClient], (httpMock: HttpTestingController, http: HttpClient) => {
//                const api: Api<ITest> = new Api<ITest>(http, urlEndPoint, Test);
//                const mockData = {
//                   data: [mockTestData],
...
//                removeMethodTest(api, httpMock, mockData, query, null);
...
//                removeByIdMethodTest(api, httpMock, mockData);
